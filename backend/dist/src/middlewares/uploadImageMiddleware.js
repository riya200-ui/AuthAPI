...
var uploadImageMiddleware = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var file;
    var _a;
    return __generator(this, function (_b) {
        try {
            ...
            if ((file === null || file === void 0 ? void 0 : file.size) > 4000) {
                ...
                return [2, res.status(400).json({ message: 'size of the file is too large' })];
            }
            if (file.mimetype !== 'image/jpeg' && file.mimetype !== 'image/png') {
                (0, removeTemp_1.removeTemp)(file.tempFilePath);
                return [2, res.status(400).json({ message: 'file format is not supported' })];
            }
            return [2, next()];
        }
        catch (error) {
