...
var authAdminMiddleware = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var user, error_1;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                return [4, User_1.default.findOne({ _id: (_a = req.user) === null || _a === void 0 ? void 0 : _a.id })];
            case 1:
                user = _b.sent();
                if ((user === null || user === void 0 ? void 0 : user.role) !== 1) {
                    return [2, res.status(403).json({
